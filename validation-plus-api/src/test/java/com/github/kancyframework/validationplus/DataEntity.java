...
public class DataEntity {
    ...
    @EnumCheck(value = AccessMode.class)
    private String enumCheck1 = AccessMode.READ.name();

    @EnumCheck(enumCode = {"READ","WRITE","EXECUTE"})
    private String enumCheck2 = AccessMode.READ.name();

    @EnumCheck(enumCodeString = "READ|WRITE|EXECUTE")
    private String enumCheck3 = AccessMode.READ.name();

    @EnumCheck(enumCodeString = "READ,WRITE,EXECUTE")
    private String enumCheck4 = AccessMode.READ.name();
