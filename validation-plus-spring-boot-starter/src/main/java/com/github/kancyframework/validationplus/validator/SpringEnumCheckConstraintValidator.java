...
import com.github.kancyframework.validationplus.constraints.EnumCheck;
 ...
 **/
public class SpringEnumCheckConstraintValidator extends CheckEmptyConstraintValidator<EnumCheck, Object> {
    private static Logger log = LoggerFactory.getLogger(SpringEnumCheckConstraintValidator.class);
